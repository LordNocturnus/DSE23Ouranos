...
# Bottom shell
alpha_bottom = 9.1 * 10**-6
sigma_y_bottom = 924 * 10**6
E_bottom = 120 * 10**9
rho_bottom = 4430
# -- Alluminum Honeycomb --
...
def backshell_geometry(peak_load, p_load=p_load, r_thermal=r_thermal, h_glider=h_glider):
    ...
    r_top_big = r_top_small / (1 - taper_ratio)
    ...
    r_bottom_small = r_bottom_big * (1 - taper_ratio)
...
def mass_bottom_shell(t):
    v_bottom_shell = volume(t_heatshield, t, diameter=r_thermal * 2)
...
def total_mass(peak_load,  p_load, r_thermal, h_glider):
    ...
    print(thermal_loads(alpha_bottom, 250, E_bottom, sigma_y_bottom))
