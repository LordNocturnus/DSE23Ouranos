...
def aeroshell_geometry(peak_load, p_load, sigma_y, E, taper, r_thermal, h_glider, h_parachute, r_parachute, delta_t, alpha):
    ...
    if buck_bottom and buck_top:
        ...
        print(f'Backshell top radiuses: {r_top_big} m, {r_top_small} m\n'
              ...
              f'Angles top and bottom: {a_top}, {a_bottom}\n'
...
if __name__ == "__main__":
    ...
    aeroshell_geometry(peak_load_entry * (m_glider + m_thermal_para), p_load, sigma_y_backshell, E, taper_ratio, r_thermal, h_glider, h_parachute, r_parachute, delta_T, alpha)