...
def t_pressure(p, r_big, a, sigma_y):
    ...
    the following website: https://www.engineersedge.com/calculators/Cone_Design_Tool/cone-design-calculator.htm
    ...
    """
    return p * r_big / (2 * np.cos(a) * (sigma_y + 0.4 * p))
...
def aeroshell_geometry(peak_load, p_load, sigma_y, taper, r_thermal, h_glider, h_parachute, r_parachute):
    """
...
if __name__ == "__main__":
    ...
    # Material Properties
    # -- Alluminum honeycomb with graphite eopxy --
    # rho_backshell = 49.7  # https://journals.sagepub.com/doi/pdf/10.1177/0021998313499949 (Q2 selected because strongest)
    # sigma_y_backshell = 41 * 10 ** 6  # https://journals.sagepub.com/doi/pdf/10.1177/0021998313499949 (Q2 selected because strongest)
    ...
    aeroshell_geometry(load_peak, p_load, sigma_y_backshell, taper_ratio, r_thermal, h_glider, h_parachute, r_parachute)
