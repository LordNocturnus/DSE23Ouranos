...
def aeroshell_geometry(peak_load, p_load, sigma_y, E, taper, r_thermal, h_glider, h_parachute, r_parachute):
    """
...
if __name__ == "__main__":
    ...
    E = 70 * 10**9  # https://www.azom.com/article.aspx?ArticleID=6618
    ...
    aeroshell_geometry(load_peak * (m_glider + m_thermal), p_load, sigma_y_backshell, E, taper_ratio, r_thermal, h_glider, h_parachute, r_parachute)
