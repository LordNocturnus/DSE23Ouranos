...
class Reentry():
    def __init__(self):
        self.m = 4976 #[kg]
        self.Ixx = 3113.4375 #[kg/m^2]
        self.Iyy = 14090.73722 #[kg/m^2]
        self.Izz = 14090.73722 #[kg/m^2]
        self.Ixz = 0 #[kg/m^2]
        self.S_ref = 14.14 #[m^2] needs to be
        self.b_ref = 3.0  #[m] assumed to be the diameter of the heatshield
        self.c_ref = 0.75*self.b_ref #[m] taken to be the height of the capsule
        self.V_0 =  26000 #[m/s]
        self.rho_0 = 3.1*10**(-13) #[kg/m^3]
        self.a_0 = 2140 #[m/s]
        ...
        self.g_0 = 6.06 #[m/s^2]
        self.gamma_0 = np.deg2rad(-33)  # [rad]
        self.mu_0 = np.deg2rad(0) #rad
        self.R_0 = 220000  # [m]
        self.gamma_prime_0 = 0
        self.theta_0 = np.deg2rad(0) #[rad]
        # self.dCD_dCM = 1
        self.dCD_dM = 0
        # self.dCL_dCM = 1
        self.C_L0 = 0
        self.L_0 = self.q_bar_0*self.S_ref*self.C_L0
        self.dCL_dAlpha = 0.5 #ALL THAT IS KNOWN IS THE SIGN
        self.dCS_dBeta =  self.dCL_dAlpha #all that is known is the sign
        self.dCD_dalpha =
        self.C_L = 0
        self.dCl_dBeta = self.dCL_dAlpha
        self.dCm_dAlpha = -0.5 #all that is know is the sign
        self.dCm_dM = 0.0
        self.dCn_dBeta = self.dCm_dAlpha
        self.dCL_dM = 0  # assumed
        self.alpha_0 = np.deg2rad(0) #[rad]
        self.dCl_dDeltaA = 0
        self.dCn_dDeltar = 0
        self.dCn_dDeltaA = 0
        self.dCm_dDeltaE = 0
